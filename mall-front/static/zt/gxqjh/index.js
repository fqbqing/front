...
App.prototype.initTicket = function () {
    ...
    // $('#ticketOpt li').on('click', function () {
    ...
    $('.signup-form select, .signup-form input').on('focus', function () {
        $(this).closest('.form-group').find('.tip').remove();
    });

    $('.closeqr').on('click', function () {
        $('.qr').addClass('qr-hide');
    });
    $('.dmblh .close-btn').on('click', function () {
        $('.dmblh').addClass('dmblh-hide');
    });
...
App.prototype.getSignupFormData = function () {
    ...
    data.ticket = 'e-ticket'; //$('#ticketOpt li.active').attr('data-type');
    return data;
};
