...
define(function (require) {
     ...
     * @constructor
     */
    function AccessRoleAuthorizationView() {
        BaseView.apply(this, arguments);
    }

    AccessRoleAuthorizationView.prototype.enableVue = true;

    /**
     * @inheritDoc
     */
    AccessRoleAuthorizationView.prototype.template = 'TPL_access_role_authorization';

    /**
     * @inheritDoc
     */
    AccessRoleAuthorizationView.prototype.uiProperties = {

    };

    AccessRoleAuthorizationView.prototype.getVueOptions = function () {
        var me = this;
        return {
            data: {},
            ready: function () {
    ...
    AccessRoleAuthorizationView.prototype.getSelectedItems = function () {
        var items = {};
     ...
     * @inheritDoc
     */
    AccessRoleAuthorizationView.prototype.uiEvents = {};

    require('er/util').inherits(AccessRoleAuthorizationView, BaseView);
    return AccessRoleAuthorizationView;
});
