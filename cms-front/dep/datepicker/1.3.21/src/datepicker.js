...
define(function (require) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
            ...
            '<button class="applyBtn ui-button" disabled="disabled"></button>&nbsp;' +
            '<button class="cancelBtn ui-button"></button>' +
            '</div>'
            '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function (options, callback) {
            ...
            if (typeof options.chosenLabel === 'string')
                this.chosenLabel = options.chosenLabel;
        ...
        clickRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                if (typeof dates[0] === 'function') {
                    this.startDate = dates[0].call();
                }
                else {
                    this.startDate = dates[0];
                }
                if (typeof dates[1] === 'function') {
                    this.endDate = dates[1].call();
                }
                else {
        ...
        updateCalendars: function () {
            ...
            this.container.find('.ranges li').each(function () {
                var $this = $(this);
                if ($this.text() === me.chosenLabel) {
                    $this.addClass('active');
                }
            });

            if (this.container.find('.ranges li:last').hasClass('active')) {
                this.showCalendars();
            }
            /*
