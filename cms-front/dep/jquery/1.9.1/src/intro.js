  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (this._options.scrollToElement === true) {
      var offset = _getOffset(targetElement.element);
      var top = offset.top;
      this._options.scrollView.scrollTop = top - 150;
    }
  ...
  function _isStaticPosition (element) {
    var p = element.parentNode;
    ...
    var position = _getPropValue(element, 'position');
  ...
  function _getOffset(element) {
    ...
    while (element && !isNaN(element.offsetLeft) && !isNaN(element.offsetTop) && element.id != 'main') {
      _x += element.offsetLeft;
      _y += element.offsetTop;
      element = element.offsetParent;
    }
