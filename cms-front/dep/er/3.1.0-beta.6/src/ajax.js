...
define(
    function (require) {
        ...
        exports.request = function (options) {
            ...
            // 支持附带凭证信息的请求 by lifayu
            // https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Access_control_CORS#.E9.99.84.E5.B8.A6.E5.87.AD.E8.AF.81.E4.BF.A1.E6.81.AF.E7.9A.84.E8.AF.B7.E6.B1.82
            if (/^http(s)?\:\/\//.test(url)) {
