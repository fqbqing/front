...
define(
    function (require) {
        ...
        exports.enterDocument = function () {
            ...
            var vueOptions = this.getVueOptions();
            if (this.enableVue) {
                var data = u.extend({}, this.model.store, vueOptions.data);
                this.vue = new Vue(u.extend(vueOptions, {
                    el: container,
                    data: data
                }));

                this.vue.$view = this;
                this.viewContext.vue = this.vue;
            }
         ...
         * @return {Object}
         */
        exports.getVueOptions = function () {
            return {};
        };

        /**
         * 获取Vue中的data值，如果不指定，则返回vue对象
         * @param {string} prop 属性名
         * @return {*}
         */
        exports.getVue = function (prop) {
            if (this.vue) {
                if (prop) {
                    return this.vue[prop];
                }
                return this.vue;
            }
            return null;
