...
/**
 * @param {string} bytes 要签名的内容.
 * @return {Array.<number>}
 */
exports.digest = function (bytes) {
  if (typeof bytes === 'string') {
 ...
 * @return {string}
 */
exports.hexdigest = function (bytes) {
  var signature = exports.digest(bytes);
  return base.byteArrayToHex(signature);
};
