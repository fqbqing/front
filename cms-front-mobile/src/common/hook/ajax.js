...
define(function (require) {
    ...
    function request(url, options) {
        ...
        //var ret = $.Deferred();
        //deferred.then(ret.resolve, function (message) {
        //    var data = {};
        //    if (typeof message === 'object' && message.redirect) {
        //        ret.reject(message.redirect);
        //    }
        //    else {
        //        // 有`pageNo`参数，就认为是需要分页的格式
        //        if (options && options.data && options.data.pageNo) {
        //            data = {
        //                data: {}
        //            };
        //        }
