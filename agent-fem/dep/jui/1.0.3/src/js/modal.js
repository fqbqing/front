...
define(function (require) {
    ...
    $.showPreloader = function (title) {
        ...
        //    title: '<div class="preloader"></div>',
        //    text: title || defaults.modalPreloaderTitle
        //});
        title = title  || defaults.modalPreloaderTitle;
        if (!$.showPreloader.preloaderModal) {
            var $toast = $.showPreloader.preloaderModal = $('<div class="modal toast preloader-modal"><div class="preloader preloader-white"></div><div class="preloader-title">' + title + '</div></div>').appendTo(document.body);
            $.openModal($toast, function(){});
        }
        else {
            $.showPreloader.preloaderModal.find('.preloader-title').html(title);
        }
        preloadCounter++;
    ...
    $.hidePreloader = function () {
        ...
        setTimeout(function () {
            ...
            if (preloadCounter === 0 && $.showPreloader.preloaderModal) {
                $.closeModal($.showPreloader.preloaderModal);
                $.showPreloader.preloaderModal = null;
            }
        }, 200);
    };
