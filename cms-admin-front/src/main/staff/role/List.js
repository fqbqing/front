...
define(function (require) {
    ...
    StaffRoleList.prototype.modelType = require('./ListModel');
    StaffRoleList.prototype.viewType = require('./ListView');
     ...
     * @override
     */
    StaffRoleList.prototype.initBehavior = function () {
    ...
    require('er/util').inherits(StaffRoleList, ListAction);
